  ...
  return (
    <div className="space-y-2 rounded-xl border border-border/60 bg-background/60 px-3 py-2">
      <div className="flex items-center justify-between gap-2">
        <p className="typography-micro text-muted-foreground">{t('ui.features.git.aiHighlights')}</p>
        <Tooltip delayDuration={1000}>
          <TooltipTrigger asChild>
            <Button
              ...
              aria-label={t('ui.features.git.insertHighlights')}
            >
              <RiArrowDownLine className="size-4" />
            </Button>
          </TooltipTrigger>
          <TooltipContent sideOffset={8}>
            {t('ui.features.git.appendHighlights')}
          </TooltipContent>
        </Tooltip>
      </div>

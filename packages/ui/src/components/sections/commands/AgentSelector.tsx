    ...
    const renderMobileAgentPanel = () => {
        ...
        return (
            <MobileOverlayPanel
                ...
                title={t('settings.agents.selectAgent')}
            >
                <div className="space-y-1">
                    ...
                    >
                        <span className={cn('typography-meta', !agentName ? 'font-medium' : 'text-muted-foreground')}>{t('settings.agents.notSelected')}</span>
            ...
            {isActuallyMobile ? (
                ...
                >
                    <div className="flex items-center gap-2">
                        ...
                        <span className="typography-meta font-medium text-foreground">
                            {agentName || t('settings.agents.selectAgentPlaceholder')}
                        </span>
                    </div>
                ...
                <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        <div className={cn(
                            ...
                            <span className="typography-micro font-medium whitespace-nowrap">
                                {agentName || t('settings.agents.notSelected')}
                            </span>
                    ...
                    <DropdownMenuContent className="max-w-[300px]">
                        ...
                        >
                            <span className="text-muted-foreground">{t('settings.agents.notSelected')}</span>
                        </DropdownMenuItem>
                        {agents.map((agent) => (
                            <DropdownMenuItem
                                key={agent.name}
